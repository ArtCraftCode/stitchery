...
class PatternsControllerTest < ActionController::TestCase
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post :create, pattern: { cut: @pattern.cut, digital: @pattern.digital, name: @pattern.name, type: @pattern.type }
    end
  ...
  test "should update pattern" do
    patch :update, id: @pattern, pattern: { cut: @pattern.cut, digital: @pattern.digital, name: @pattern.name, type: @pattern.type }
    assert_redirected_to pattern_path(assigns(:pattern))
  end
